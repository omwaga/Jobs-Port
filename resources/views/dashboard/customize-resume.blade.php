     ...
     <div class="row">
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="text" name="education_date" v-model="form.education_date" class="form-control form-control-sm" placeholder="Dates">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="name">City</label>
          <input type="text" name="education_city" v-model="form.education_city" class="form-control form-control-sm" placeholder="City">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
