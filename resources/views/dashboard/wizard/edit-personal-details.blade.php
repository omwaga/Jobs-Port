 ...
 <select name="religion" class="form-control" style="border-radius:0px;" required autofocus>
  ...
  <div class="row">
     <div class="col-md-4">
          ...
          <select name="nationality" class="form-control" style="border-radius:0px;"required autofocus >
               <option>{{$personalinfo->nationality}}</option>
    ...
    <div class="col-md-4">
          ...
          <select name="city" class="form-control" style="border-radius:0px;"required autofocus value="{{old('city')}}">
               <option>{{$personalinfo->city}}</option>
