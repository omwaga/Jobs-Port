        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h5 class="pageheader-title">Job Post Templates</h5>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/Employer-dashboard" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Job Post Templates</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">All Job Templates</h5>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a  href="/use-template/{{$template->job_title}}" class="btn btn-info btn-sm text-white">
                                        <i class="fa fa-eye"></i>Use Template
                                    </a>
                                </td>
                            </tr>
                            @endforeach
