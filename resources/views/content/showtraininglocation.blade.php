...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-8"> 
        <label>Current Search: {{$town->name}}</label>
<!-- Buttons to choose list or grid view -->
<button class="btn btn-light pull-right" onclick="listView()"><i class="fa fa-bars"></i> List View</button>
<button class="btn btn-light pull-right" onclick="gridView()"><i class="fa fa-th-large"></i> Detailed View</button>
...
<div class="row">
    ...
    @foreach($town->trainings as $training)
  <div class="column card card-body border-light shadow-lg p-3 mb-5 bg-white rounded" style="background-color:#aaa;">
   ...
   @endforeach
   @else
  <p>Nothing to show in this location</p>
  @endif
</div>
</div>
<div class="col-md-4">
  ...
  <div class="card">
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
          <ul>
              <li>
                  <form method="GET", action="{{route('sortlocation')}}">
                      <input name="location" type="hidden" value="{{$town->id}}">
              ...
              <li>
                  <form method="GET", action="{{route('sortlocation')}}">
                      <input name="location" type="hidden" value="{{$town->id}}">
                <input name="sortby" type="hidden" value="latest">
              <button type="submit" class="nav-link btn btn-group" style="color:#0B0B3B;">
                      <i class="fas fa-angle-right"></i>
                     Latest
               </button>
