...
<div class="col-md-12">
    <div class="row">
        <div class="col-md-8"> 
        <label>Current Search: {{$training_type}}</label>
...
<div class="row">
  ...
  <div class="column card card-body border-light shadow-lg p-3 mb-5 bg-white rounded" style="background-color:#aaa;">
    ...
    <div class="col-md-3">
                ...
                <div class="col-md-9">
                <p class="text-dark">
                    {{$training->short_description}} <a class="btn btn-danger pull-right" href="/trainingcourses/training/{{$training->id}}">See the course</a>
                </p>
                </div>
     </div>
     </div>   
  ...
  <div class="card">
    ...
    <div id="collapseFour" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
          <ul>
              <li>
                  <form method="GET", action="{{route('sorttype')}}">
                      <input name="training_type" type="hidden" value="{{$training_type}}">
