...
<div class="wrapper">
  ...
  <!--Start row-->
  <form method="POST" action="{{route('supersave')}}">
    @csrf
    <div class="row">
      @include('errors')
      @include('success')
      <div class="col-md-6">
        <div class="white-box">
          ...
          <div class="form-group">
            ...
            <input class="form-control" value="{{old('jobtitle')}}" name="jobtitle"  placeholder="Enter Title" type="text" required="">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name="expirydate" value="{{old('expirydate')}}" class="form-control" placeholder="mm/dd/yyyy" type="date" id="datepicker-autoclose" required="">
          </div>
        </div>
      </div> <!--/.col-md-6-->
      ...
      <div class="col-md-6">
       <div class="white-box">
        ...
        <div class="form-group">
          ...
          <input name="salary" value="{{old('salary')}}" class="form-control" placeholder="00.00" type="text" required="">
        </div>
      </div>
    </div><!-- /.col-md-6-->
