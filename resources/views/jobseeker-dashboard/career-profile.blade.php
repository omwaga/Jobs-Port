...
<div class="row">
  ...
  @include('jobseeker-dashboard.wizard.edit-personal-details')
</div>
@endif
<br><hr>
...
<form method="POST" action="{{route('personalstatements.store')}}"> 
  @csrf
  <div class="row">
    <div class="col-md-12">
...
<div class="col-md-2">
  ...
  @include('jobseeker-dashboard.wizard.edit-personal-statements')
</div>
</div>
@endif
<br><hr>
...
<div class="row">
  ...
  <div class="col-md-8">
    ...
    <div class="col-md-4">
      ...
      @include('jobseeker-dashboard.wizard.edit-experience')
      @include('jobseeker-dashboard.wizard.new-experience')
    </div>
    @endforeach
  </div>
  @endif
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    @include('jobseeker-dashboard.wizard.new-education')
    @include('jobseeker-dashboard.wizard.edit-education')
  </div>
  @endforeach
</div>
@endif
...
<div class="col-md-4">
  ...
  @include('jobseeker-dashboard.wizard.new-award')
  @include('jobseeker-dashboard.wizard.edit-award')
</div>
@endforeach
</div>
@endif
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    @include('jobseeker-dashboard.wizard.new-reference')
    @include('jobseeker-dashboard.wizard.edit-reference')
  </div>
  @endforeach
</div>
@endif
...
@if(!$skills->count())
<form method="POST" action="{{route('jobskills.store')}}">
  @csrf
  <div class="row">
    <div class="col-md-6">
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    @include('jobseeker-dashboard.wizard.new-skill')
    @include('jobseeker-dashboard.wizard.edit-skill')
  </div>
  @endforeach
</div>
@endif
