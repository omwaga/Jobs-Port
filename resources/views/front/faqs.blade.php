  ...
  <div class="row">
    ...
    <div class="col-md-9">
        ...
        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
          ...
          <div class="container">
            <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
              <h5 style="color:#0B0B3B;"><a href="#">What is The NetworkedPros?</a></h5>

              <div class="row">
                <div class="col-md-9">
                  <p class="text-dark">
                    Answer:<br>
                    The NetworkedPros philosophy is to connect you with resources for job searching & for moving up the career ladder.
                    <a href="{{route('Register')}}" class="text-primary">Click here to sign up</a> on The NetworkedPros!
                  </p>
                </div>
              </div>
            </div> 
          ...
          <div class="container">
            <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
              <h5 style="color:#0B0B3B;"><a href="#">What are the benefits of signing up on The NetworkedPros as a job seeker?</a></h5>
          ...
          <div class="container">
            <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
              <h5 style="color:#0B0B3B;"><a href="#">How do I sign up on The NetworkedPros?</a></h5>

              <div class="row">
                <div class="col-md-9">
                  <p class="text-dark">
                    Answer:<br>
                    Visit <a href="{{route('Register')}}" class="text-primary">NetworkedPros Registration Page</a> and add your details to sign up.!
                  </p>
                </div>
              </div>
            </div> 
          ...
          <div class="container">
            <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
              <h5 style="color:#0B0B3B;"><a href="#">What type of jobs does The NetworkedPros post?</a></h5>

              <div class="row">
                <div class="col-md-9">
                  <p class="text-dark">
                    Answer:<br>
                    The NetworkedPros posts jobs from all industries. Visit 
          ...
          <div class="container">
            <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
              <h5 style="color:#0B0B3B;"><a href="#">How do i get a job through The NetworkedPros?</a></h5>
      ...
      <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
        ...
        <div class="container">
          <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
            <h5 style="color:#0B0B3B;"><a href="#">Once I posted a Job for how long my job will remain on The NetworkedPros?</a></h5>
        ...
        <div class="container">
          <div class="card card-body border-light shadow-sm p-3 mb-3 bg-white rounded" style="background-color:#aaa;">
            <h5 style="color:#0B0B3B;"><a href="#">How long will it take for my job to get live on The NetworkedPros website?</a></h5>
