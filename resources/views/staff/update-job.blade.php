...
<div class="dashboard-wrapper">
  <div class="container-fluid dashboard-content ">
          ...
          <div class="page-breadcrumb">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('team.jobs')}}" class="breadcrumb-link">Posted Jobs</a></li>
    ...
    <div class="card">
     ...
     <div class="card-body">
       @include('errors')
       <form role="form" method="post" action="{{route('team.updatejob', $jobpost->id)}}">
         @method('PATCH')
