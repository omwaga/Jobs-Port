...
<div class="dashboard-wrapper">
                ...
                <div class="page-header">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="employer.team" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{route('team.jobs')}}" class="breadcrumb-link">Published Jobs</a></li>
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                <a href="{{route('team.edit.post', $job->id)}}" class="btn btn-info btn-sm text-white float-right">Update</a>
            </div>
        </div>
    </div>
</div>
