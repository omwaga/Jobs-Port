...
<head>
  ...
  <title>The NetworkPros - Jobs in East Africa</title>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list nav-active"><a href=""><i class="icon-home"></i> <span>Dashboard</span></a>
                </li>
                ...
                <li class="menu-list"><a href="#"><i class="icon-layers"></i> <span>Job Posts</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="{{route('createjob')}}"> New Job </a></li>
