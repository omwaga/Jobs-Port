...
<div class="container-fluid position-relative py-md-5 py-0 bg-danger"><br>
  <div class="row">
            <div class="col-lg-12  text-center">
              ...
              <a href="#" class="btn btn-outline-white btn-lg px-4 text-white" data-toggle="modal" data-title="" data-caption="" data-target="#alert" style="background-color:#0B0B3B;"> CREATE JOB ALERTS </a>
            </div>
          </div>
