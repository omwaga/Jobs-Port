@extends('layouts.app')
@section('content')
<section class="section section-top section-full"  style="padding-top:0.8rem">
    ...
    <article class="container">
        <div class="row">
	    <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg col-md-8">
		    <header class="resume-header pt-4 pt-md-0">
			    <div class="media flex-column flex-md-row">
				    <img class="img-fluid rounded-circle img-thumbnail mx-auto mb-2" src="{{asset('assets/images/profile.jpg')}}" alt="" style="width:250px;height:250px">
	    ...
	    <div class="col-md-4">
	    <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg" style="padding-left:4px;">
	        <br>
	        ...
	        <div class="form-group">
	            ...
	            <select class="form-control">
	                ...
	                <option>Over 8 Years</option>
	            </select>
	        </div>
	        <button class="btn pull-right text-white" style="background-color:#070A53;">Know More</button>
	        <br><br><hr>
	    </div>
	    </div>
	    </div>
