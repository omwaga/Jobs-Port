...
<div class="container" style=" padding-top: 7rem;">
    <div class="row justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header text-center bg-light"><b><h6>{{ __('Already Registered? Login') }}</h6></b></div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('authuser') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input id="login_email" type="email" class="form-control @error('login_email') is-invalid @enderror" name="login_email" value="{{ old('login_email') }}" required autocomplete="email" autofocus
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header text-center bg-light"><b><h6>{{ __('Not Registered? Sign Up') }}</h6></b></div>
            <div class="card-body">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control @error('register_email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
