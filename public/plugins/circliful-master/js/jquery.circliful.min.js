...
$("#test-circle-one").circliful({animation:1,animationStep:5,foregroundBorderWidth:12,backgroundBorderWidth:12,percent:90,backgroundColor:"#fff",foregroundColor:"#a700ec",fontColor:"#a700ec",textSize:12,textStyle:"font-weight: 600;",textColor:"#a700eb",multiPercentage:1,percentages:[10,20,30]}),$("#test-circle-two").circliful({animation:1,animationStep:5,foregroundBorderWidth:12,backgroundBorderWidth:12,percent:90,textSize:30,backgroundColor:"#fff",foregroundColor:"#2aa0ff",fontColor:"#2aa0ff",textStyle:"font-size: 12px;",textColor:"#7c27ff",multiPercentage:1,percentages:[10,20,30]}),$("#test-circle-three").circliful({animation:1,animationStep:5,backgroundColor:"#fff",foregroundColor:"#ff9034",fontColor:"#ff9034",foregroundBorderWidth:12,backgroundBorderWidth:12,percent:76,textSize:30,textStyle:"font-size: 12px;",textColor:"#d21158",multiPercentage:1,percentages:[10,20,30]}),$("#test-circle-four").circliful({animation:1,animationStep:5,foregroundBorderWidth:12,backgroundBorderWidth:12,backgroundColor:"#fff",foregroundColor:"#d000bb",fontColor:"#d000bb",percent:79,textSize:30,textStyle:"font-size: 12px;",textColor:"#d21158",multiPercentage:1,percentages:[10,20,30]});